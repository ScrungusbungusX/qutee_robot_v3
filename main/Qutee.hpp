...
#define TFT_DC         9     // example GPIO for DC
#define TFT_RST        17    // example GPIO for RST
#define TFT_BACKLITE   18    // GPIO controlling backlight
#define TFT_I2C_POWER  -1    // GPIO controlling I2C power (if used)
